...
#     img_crown = cv2.cvtColor(img_crown, cv2.COLOR_BGR2GRAY)
    img = img[28:28+img_crown.shape[0],728:728+img_crown.shape[1]]
#     np.array_equal(img_crown, img[28:28+img_crown.shape[0],728:728+img_crown.shape[1]])
#     cv2.imwrite('test1.png',img)
#     cv2.imwrite('test2.png',img_crown)
    runAllImageSimilaryFun(img,img_crown)